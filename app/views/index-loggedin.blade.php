...
<div id="sectionOne">
    ...
    <section id="introduction">
        <h2 id="intro-paragraph-loggedin">Hi Karyn, please start editing your content.<br><br>You may edit, Services, Pricing, Testimonials and Posts.<br>This will automatically be saved to your database.</h2>
